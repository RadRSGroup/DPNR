...
const enrollment_service_1 = require("../../../src/services/enrollment.service");
...
describe('EnrollmentService', () => {
    ...
    let testCohort;
    beforeEach(async () => {
        enrollmentService = new enrollment_service_1.EnrollmentService();
    ...
    describe('createEnrollment', () => {
        ...
        it('should throw error when cohort is at capacity', async () => {
            ...
            const fullCohort = await (0, setup_1.createTestCohort)({ capacity: 1 });
            ...
            // Create second user
            const secondUser = await (0, setup_1.createTestUser)({
...
//# sourceMappingURL=enrollment.service.test.js.map