...
const TIERS = [
  {
    ...
    tokens: '10,000',
    sessions: '~3',
    features: ['3 AI-guided decisions/mo', 'Full 7-step flow', 'Basic history'],
    cta: null,
    highlight: false,
  },
  {
    ...
    tokens: '150,000',
    sessions: '~50',
    features: ['50 AI-guided decisions/mo', 'Full 7-step flow', 'Full history', 'Priority AI response'],
    cta: 'Upgrade to Core',
    highlight: true,
  },
  {
    ...
    tokens: '400,000',
    sessions: '~133',
    features: ['133 AI-guided decisions/mo', 'Full 7-step flow', 'Full history', 'Priority AI response', 'Early access to new features'],
    cta: 'Upgrade to Pro',
    highlight: false,
  },
]
